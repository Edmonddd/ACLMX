...
parser.add_argument('--visible_gpu', default=0,help='Use gpu/cpu, put "cuda" if gpu and "cpu" if cpu')
...
tokenizer = AutoTokenizer.from_pretrained("/home/lxm/ACLM-main/facebook/mbart-large-50",src_lang=args.lang, tgt_lang=args.lang)
...
model = AutoModelForSeq2SeqLM.from_pretrained("/home/lxm/ACLM-main/facebook/mbart-large-50")
