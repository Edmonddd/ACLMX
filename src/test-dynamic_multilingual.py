...
parser.add_argument('--model',default="../data/100/zh_sample_train_attn_0.3_xlm-roberta-large-0.3-false-gauss-attention-dynamic-0.3-5-false-100-xlm-large-zh-42-retrain-final", help='which model to use')
...
parser.add_argument('--directory','-dir', default="../data/100", help='data directory where train and dev files are located')
...
parser.add_argument('--root_dir','-ro', type=str, default="../data/100", help='root directory')
