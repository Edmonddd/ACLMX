...
parser.add_argument('--output_folder', '-o',  default="../data/100/zh_sample_train_attn_0.3_xlm-roberta-large-0.3-false-gauss-attention-dynamic-0.3-5-false-100-xlm-large-zh-42-retrain",help='Name of the output folder')
...
parser.add_argument('--consistency_model', '-cm', type=str,  default='gauss',help='Model to check the consistency of generated file')
...
parser.add_argument('--ckpt',type=str, default="../data/100/zh_flair_xlm_100/best-model.pt",help="checkpoint path")
