...
parser = argparse.ArgumentParser(description='Train flair model')
parser.add_argument('--input_folder', '-i', default="/home/hsq/ACLM-main/data/ace04",help='Name of the input folder containing train, dev and test files')
parser.add_argument('--output_folder', '-o', default="/home/hsq/ACLM-main/data/ace04/ace04_flair_xlm_100",help='Name of the output folder')
parser.add_argument('--gpu', '-g', default='cuda:0',help='Use gpu/cpu, put "cuda" if gpu and "cpu" if cpu')
parser.add_argument('--dev_file', '-d', default="ace04_dev.conll", help='Name of the input folder containing train, dev and test files')
parser.add_argument('--checkpoint', '-ckpt', default='/home/hsq/ACLM-main/data/ace04/ace04_flair_xlm_100/best-model.pt', help='path to checkpoint')
parser.add_argument('--input_file', '-if', default='ace04_test.conll', help='Name of the test file')
